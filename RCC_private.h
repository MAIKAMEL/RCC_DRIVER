...
#define APB2_BUSNR		      (*(((volatile u32* )(MRCC_BASE_ADDRESS + 0x50)))
#define RCC_AHB2LPENR	      (*(((volatile u32* )(MRCC_BASE_ADDRESS + 0x54)))
#define RCC__APB1LPENR	 	  (*(((volatile u32* )(MRCC_BASE_ADDRESS + 0x60)))
#define RCC__APB2LPENR		  (*(((volatile u32* )(MRCC_BASE_ADDRESS + 0x64)))
